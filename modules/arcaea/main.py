...
class Arcaea(object):
    ...
    def _music_get(self, local: bool) -> Tuple[dict,bool]:
        ...
        if local:
            with open(os.path.join(self.STATIC_PATH, 'song_dict.json'), 'r', \
                    encoding='utf-8') as f:
    ...
    def _chart_get(self, local: bool) -> Tuple[dict,bool]:
        ...
        if not local:
            ...
            if isinstance(resp, dict):
                ...
                with open(os.path.join(self.STATIC_PATH, 'const_dict.json'), 'w', \
                        encoding='utf-8') as f:
                    f.write(const_dict)
                    f.close()
            else:
                ...
                success = False
        if local:
            with open(os.path.join(self.STATIC_PATH, 'const_dict.json'), 'r', \
                    encoding='utf-8') as f:
    ...
    def _complex_artist_get(self, local: bool) -> Tuple[dict,bool]:
        ...
        if not local:
            ...
            if isinstance(resp, dict):
                ...
                with open(os.path.join(self.STATIC_PATH, "complex_artist.json"),\
                ...
                success = False
        if local:
            with open(os.path.join(self.STATIC_PATH, 'complex_artist.json'), 'r', \
                    encoding='utf-8') as f:
    ...
    def _music_length_get(self, local: bool) -> Tuple[dict,bool]:
        ...
        if not local:
            ...
            if isinstance(resp, dict):
                ...
                with open(os.path.join(self.STATIC_PATH, "song_len.json"),\
                          "w", encoding="utf-8") as f:
                ...
                success = False
        if local:
            with open(os.path.join(self.STATIC_PATH, 'song_len.json'), 'r', \
                    encoding='utf-8') as f:
    ...
    def _ver_time_get(self, local: bool) -> Tuple[dict,bool]:
        ...
        if not local:
            ...
            if isinstance(resp, dict):
                ...
                with open(os.path.join(self.STATIC_PATH, "version_time.json"),\
                          "w", encoding="utf-8") as f:
                ...
                success = False
        if local:
            with open(os.path.join(self.STATIC_PATH, 'version_time.json'), 'r', \
                    encoding='utf-8') as f:
